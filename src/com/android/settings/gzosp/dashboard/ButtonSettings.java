...
import com.asylum.core.logging.SlimMetricsLogger;
import com.asylum.action.ActionsArray;
import com.asylum.action.ActionConstants;
import com.asylum.action.ActionHelper;
import com.asylum.utils.AppHelper;
import com.asylum.utils.HwKeyHelper;
...
public class ButtonSettings extends SettingsPreferenceFragment implements
    ...
    private void resetToDefault() {
        for (String settingsKey : mKeySettings.keySet()) {
            if (settingsKey != null) {
                AsylumSettings.System.putStringForUser(getActivity().getContentResolver(),
                settingsKey, null, UseHandler.USER_CURRENT);
            }
        }
        AsylumSettings.System.putInt(getContentResolver(),
                AsylumSettings.System.DISABLE_HW_KEYS, 0, UserHandle.USER_CURRENT);
        reloadSettings();
    }
    ...
    public void shortcutPicked(String action,
        ...
        AsylumSettings.System.putStringForUser(getContentResolver(),
                mPendingSettingsKey, action, UserHandle.USER_CURRENT);
        reloadSettings();
                    ...
                    .setItems(getOwner().mActionsArray.getEntries(),
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (getOwner().mActionsArray.getValue(item)
                                ...
                                AsylumSettings.System.putStringForUser(getActivity().getContentResolver(),
                                        settingsKey,
                                        getOwner().mActionsArray.getValue(item), UserHandle.USER_CURRENT);
